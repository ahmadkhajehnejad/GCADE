...
class Args(BaseArgs):
    def __init__(self):
        ...
        self.note = 'Gransformer-3layers-nomodellayernorm-estnumnodes' # -typededges' # -nhead1-nensemble1' # -gattk8log' # -trainpr0.2,valpr0.2,testpr0.2 # grposenck8log-bfsincpar'
