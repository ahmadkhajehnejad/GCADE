...
class Args(BaseArgs):
    def __init__(self):
        ...
        self.note = 'Gransformer-6layers-nomodellayernorm-feedgraphlength-MADEhl2msk1natuord1dimred1-typededges-gattk16norm-grposenck16norm' # -estnumnodes-exactgen' # -bfsincpar' # ' #-sepoptepoch20 # -separateTerminationBit' # '  # -allowAllZeros' #' #   ' # -useminnumnodes' #  ' # # ' # ' # -weightpositions' # ' # -posoutputoneHot' # -posoutputtril' #  -nhead1-nensemble1' # ' # -trainpr0.2,valpr0.2,testpr0.2 #'
