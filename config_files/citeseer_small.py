...
class Args(BaseArgs):
    def __init__(self):
        ...
        self.note = 'Gransformer-3layers-nomodellayernorm-separateTerminationBit' # -sepoptepoch200' #-MADEhl2msk1natuord1dimred1' # -allowAllZeros-useminnumnodes' # ' # -weightpositions' # -noTerminationBit' #  # -typededges' # -estnumnodes -nhead1-nensemble1' # -gattk4log' # -trainpr0.2,valpr0.2,testpr0.2 # grposenck4log-bfsincpar'
