...
class Args(BaseArgs):
    def __init__(self):
        ...
        self.note = 'Gransformer-3layers-nomodellayernorm-separateTerminationBit1-weightterminationbit,100,10' # -sepoptepoch3' #-MADEhl2msk1natuord1dimred1' # -allowAllZeros-useminnumnodes' # ' # -weightpositions' # -noTerminationBit' #  # -typededges' # -estnumnodes -nhead1-nensemble1' # -gattk4log' # -trainpr0.2,valpr0.2,testpr0.2 # grposenck4log-bfsincpar'
